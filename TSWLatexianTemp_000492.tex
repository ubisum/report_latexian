...
Within the wide field of robotics, mobile robots gained much attention in recent years, because of the great ambit in which they can be involved in. Just to mention some of the areas of interest in which mobile robots are requested to operate, consider animation of digital characters, space exploration, mapping of and navigation in unknown and/or changing environments. \\
...
%\includegraphics[width=0.4\textwidth]{images/nao.jpg}\\
%\includegraphics[width=0.4\textwidth]{images/rescue.jpg}\\
%\includegraphics[width=0.4\textwidth]{images/quadrotor.jpg}
...
\centerline{\includegraphics[width=0.4\textwidth]{images/rescue.jpg}}
(a)
\end{minipage} \\
\vspace{10mm}%
\begin{minipage}[c]{0.9\textwidth}
\centering\setlength{\captionmargin}{0pt}%
\centerline{\includegraphics[width=0.9\textwidth]{images/quadrotor.jpg}}
(b)
\vspace{10mm}%
\begin{minipage}[c]{0.9\textwidth}
\centering\setlength{\captionmargin}{0pt}%
